...
$PostsData = new WebScraping('https://wockhardtschools.com/blog/');
...
$posts_title = $PostsData->pathObj->query('//h2[@class="entry-title"]')->item(0)->nodeValue;
// echo "string";
// exit;
// Getting the posts author

$posts_author = $PostsData->pathObj->query('//div[@class="entry-meta"]/span[@class="author vcard"]/a')->item(0)->nodeValue;

// Getting the posts release date

$posts_Releasedate = $PostsData->pathObj->query('//div[@class="entry-meta"]/span[@class="date"]/a')->item(0)->nodeValue;

// getting names of all the recent posts

//note we havent used item(0)->nodeValue as we need all the data within <a> tag

$recent_posts = $PostsData->pathObj->query('//div[@class="widget-post-list-item "]/div[@class="title"]/a');
...
$tags = $PostsData->pathObj->query('//div[@class="entry-meta"]/span[@class="categories-links"]/a');
